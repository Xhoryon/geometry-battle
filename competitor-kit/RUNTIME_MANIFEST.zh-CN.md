...
| 实现 | CPython |
| 版本 | 3.9.6 |
| 启动方式 | 由平台用固定 argv 启动（见 [ALGORITHM_REQUIREMENTS.zh-CN.md](ALGORITHM_REQUIREMENTS.zh-CN.md)） |
...
临时文件请用 `tempfile` 或当前工作目录，见 [ALGORITHM_REQUIREMENTS.zh-CN.md](ALGORITHM_REQUIREMENTS.zh-CN.md) §8「工作区与临时文件」。
